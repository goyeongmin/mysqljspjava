...
<a href="<%= request.getContextPath() %>/gsearch/g_search_list.jsp">05상품검색	</a>	
<a href="<%= request.getContextPath() %>/glist/g_list.jsp">06상품리스트	</a>
<%		
...
%>
<a href="<%= request.getContextPath() %>/minsert/m_insert_form.jsp">01회원등록	</a>
<a href="<%= request.getContextPath() %>/mlist/m_list.jsp">02회원목록	</a>
<a href="<%= request.getContextPath() %>/msearch/m_search_list.jsp">03회원검색	</a>
<a href="<%= request.getContextPath() %>/Goods/goods_insert_form.jsp">04상품등록	</a>
<a href="<%= request.getContextPath() %>/gsearch/g_search_list.jsp">05상품검색	</a>
<a href="<%= request.getContextPath() %>/glist/g_list.jsp">06상품리스트	</a>
<%		
